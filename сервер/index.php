...
<link href="https://fonts.googleapis.com/css2?family=Playfair+Display:ital,wght@0,600;0,700;0,800;0,900;1,700&family=Manrope:wght@400;500;600;700;800&family=JetBrains+Mono:wght@500;700;800&display=swap" rel="stylesheet">
<style>
...
.logo{display:flex;align-items:center;gap:11px;font-family:var(--disp);font-weight:800;font-size:22px;letter-spacing:.05em}
...
.hero h1{font-size:clamp(42px,5.8vw,76px);line-height:1.03;margin-bottom:16px}
...
.grid{display:grid;grid-template-columns:repeat(auto-fill,minmax(224px,1fr));gap:26px}
...
.card-cover{position:relative;aspect-ratio:3/4;overflow:hidden;background:var(--bg2)}
...
.skl-cover{aspect-ratio:3/4;background:var(--panel2)}
...
.verdict{font-family:var(--disp);font-weight:700;font-size:17px;letter-spacing:.1em;text-transform:uppercase;
